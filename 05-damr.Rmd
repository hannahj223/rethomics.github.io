...
We suggest to exclude animals *a priori* (e.g. because they died) by recording them as dead **in the metadata**. This way data is not modified or omitted and can easily be recovered if needed.
...
This practice has the advantage of making it **very transparent**, why some individuals were excluded.
