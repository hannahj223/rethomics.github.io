...
3. **Write individual information** -- you make a spreadsheet (CSV file) that details the experimental conditions **for each individual**. We call this a **metadata file**. It is a crucial concept in rethomics, so we will dedicate time to it in the [next section](#metadata). You can often write your metadata as you plan your experiment, but sometimes, you want to enrich it with variables that you can only record after your experiment (e.g. lifespan).
