...
For instance, if we are interested in the effect of sex and genotype on sleep amount, we can make a faceted boxplot, and also add individual points to show all data.
